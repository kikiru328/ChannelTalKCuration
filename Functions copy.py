...
def BMR_calories_calculation(user_weight:int, user_height:int, user_age:int) -> int:
...
def table(user_goal):
    ...
    if user_goal == '5Kg 이상의 감량을 원하세요?' : return f'{url}/more_5_reduce.png'
    elif user_goal == '5Kg 미만의 감량을 원하세요?' : return f'{url}/less_5_reduce.png'
    elif user_goal == '5kg 이상의 증량을 원하세요?' : return f'{url}/gain_5.png'
